...
%% indpensim code
function [X] = indpensim(f_input, Xd, x0, h, T, solv, p, Ctrl_flags,Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA)
...
%    waitbar(k / N);
    ...
    % gets MVs
    [u X] = f_input(X, Xd, k, h, T,Ctrl_flags,Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA);
