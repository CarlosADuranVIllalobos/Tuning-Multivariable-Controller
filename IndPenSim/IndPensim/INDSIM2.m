...
function [Xref] = INDSIM2(Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA,xini,Batch_no,Seed_ref,Rand_ref)
...
if(Ctrl_flags.IC==0)
    ...
    Rand_ref =Rand_ref+1;
    intial_conds = 0.5+0.05* .05; % X_0 (g h^-1)
    rng(Seed_ref+Batch_no +Rand_ref); 
    Rand_ref =Rand_ref+1;
...
[Xref] = indpensim(@fctrl_indpensim, Xinterp, x0, h, T,2,par,Ctrl_flags,Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA);
