...
function [Recipe_Fs_sp,Recipe_PAA_sp,yest] = fast_controller(Xref,c_param,cp)
...
[Xtrain,xp,Porg,Worg,Eorg,xmean2,xstd2,M]=orgplsmpcM(c_param.X2,c_param.P,c_param.W,c_param.E,c_param.xmean,...
    c_param.xstd,c_param.num_x,c_param.num_u,c_param.bt,c_param.ustart,xc,cp,c_param.invar,c_param.M);  %organize variables for MPC
...
%Bootstrap method
%M=diag(M((np+1:np+nu)));%MVT control tunning

vol_con=29000; %constraint on volume
ysppls=(c_param.ysp-c_param.ymean)./c_param.ystd;%
[ufuture,H,Fu,yest,tk]=mvtoptujtju(Xtrain,ysppls,xk,np,nu,nk,Eorg,c_param.T,Porg,Worg,c_param.Q,...
    xmean2,xstd2,c_param.ymean,c_param.ystd,upper,lower,M,vol_con);
