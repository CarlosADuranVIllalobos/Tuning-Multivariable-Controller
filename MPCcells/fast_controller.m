...
function [Recipe_Fs_sp,yest] = fast_controller(Xref,c_param,cp,unom_Fs)
...
[ufuture,H,Fu,yest,tk]=mvtoptu1(Xtrain,ysppls,xk,np,nu,nk,Eorg,c_param.T,Porg,Worg,c_param.Q,...
