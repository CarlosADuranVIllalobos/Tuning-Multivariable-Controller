...
function [Xref,unom_Fs,unom_PAA,yest] = INDSIM2(Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA,xini,Batch_no,Seed_ref,Rand_ref,contr_param)
...
[Xref,unom_Fs,unom_PAA,yest] = indpensim(@fctrl_indpensim, Xinterp, x0, h, T,2,par,Ctrl_flags,Recipe_Fs,Recipe_Fs_sp,Recipe_PAA,Recipe_water_PAA,contr_param);
